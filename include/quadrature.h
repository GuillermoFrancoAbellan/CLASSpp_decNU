...
#define _QTHRES_OVER_QMAX_ 0.35 // GFA, parameter used only for new quadrature qm_trapz_piecewise
#define _NQLOW_OVER_NQTOT_ 0.6 // GFA, parameter used only for new quadrature qm_trapz_piecewise
...
enum quadrature_method {qm_auto, qm_Laguerre, qm_trapz_indefinite, qm_trapz, qm_trapz_piecewise}; //GFA, added new quadrature method
